...
/* Set request for daemon, low state is active */
void pidaemon_SetRequest()
{
	clrbit(PIDAEMON_PI_INT_REQUEST_PORT.OUT, PIDAEMON_PI_INT_REQUEST_PIN);
}

/* Clear request for daemon, low state is active */
